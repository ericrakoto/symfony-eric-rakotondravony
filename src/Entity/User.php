...
class User implements UserInterface
{
     ...
     * @Assert\EqualTo(propertyPath="confirmerpassword", message="Votre mot de passe doit etre la même")
     */
    private $password;

    /**
     * @Assert\EqualTo(propertyPath="password", message="Veuillez vérifier le mot de passe")
     */
    ...
    {
        return (string) $this->confirmerpassword;
    }
