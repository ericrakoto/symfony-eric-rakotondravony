...
class AuteurController extends AbstractController
{
    ...
    /**
     * @Route("/auteur/new", name="auteur_new", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/auteur/{id}/edit", name="auteur_edit", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/auteur/{id}", name="auteur_delete", methods={"DELETE"})
     */
